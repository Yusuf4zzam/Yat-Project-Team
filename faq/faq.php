...
<meta name="description" content="Come To See Our Solution and How Use Our Website">
<meta name="keywords" content="ExGames, FAQ Exgames">
    ...
    <div class="faq">
      <div class="container">
        ...
        <div class="content flexbetween">
          <div class="left-box">
            <div class="head">
              <h2>01. XGames member</h2>
            </div>
            <div class="text">
              <h4> <i class="fas fa-plus"></i><i class="fas fa-minus"></i>Redug Lefes Dolor Sit Amet.</h4>
              <p>XGames Studios has been creating innovative games since 2003. We offer our clients professional development services, ranging from concept prototyping.</p>
            </div>
            <div class="text">
              <h4> <i class="fas fa-plus"></i><i class="fas fa-minus"></i>Laboriosam Maiores Alias Accusamus</h4>
              <p>XGames Studios has been creating innovative games since 2003. We offer our clients professional development services, ranging from concept prototyping.</p>
            </div>
            <div class="text">
              <h4> <i class="fas fa-plus"></i><i class="fas fa-minus"></i>Mollitia Dolore Magnam Quidem Repellat</h4>
              <p>XGames Studios has been creating innovative games since 2003. We offer our clients professional development services, ranging from concept prototyping.</p>
            </div>
            <div class="text">
              <h4> <i class="fas fa-plus"></i><i class="fas fa-minus"></i>Quas Mollitia Dolore Magnam</h4>
              <p>XGames Studios has been creating innovative games since 2003. We offer our clients professional development services, ranging from concept prototyping.</p>
            </div>
          </div>
          <div class="right-box">
