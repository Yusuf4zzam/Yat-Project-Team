<?php
  ...
  if($_SERVER["REQUEST_METHOD"] == "POST")
  {
    ...
    if(!(empty($name) && empty($email) && empty($message)))
    {
      ...
      if(!$done)
      {
        die("Couldn't enter data: ".mysqli_error ($link));
      }
...
<meta name="description" content="Contct Us To Fix Your Problem We're Here To Help You">
<meta name="keywords" content="ExGames, contact Exgames">
...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <style>
      #aap
      {color: #D64481;opacity:2;transition:opacity 800ms;}
      #aap.waa {opacity:0;}
    </style>
  </head>
  <body>
    ...
    <div class="contact">
      <div class="container">
        ...
        <script>setTimeout(function(){document.getElementById('aap').className = 'waa';}, 3000);</script>
        <p id="aap"><?php echo $thank; ?></p><br>
        <form method="post" class="flexbetween" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>"">
