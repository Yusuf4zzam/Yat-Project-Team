...
<meta name="description" content="See Owr Amazing Team Who's Develoe This Wep For You.">
<meta name="keywords" content="ExGames, Exgames Team, Team Exgames">
    ...
    <div class="team">
      <div class="container">
        ...
        <div class="content flexbetween">
          <div class="box"><img src="images/t1.jpg" alt="">
            <h2>Yusuf Azzam</h2>
            <p>Front-End-Developer</p>
            <div class="links"><a class="facebook" href=""><i class="fab fa-facebook-f"></i></a><a class="insta" href=""><i class="fab fa-instagram"></i></a><a class="twitter" href=""><i class="fab fa-twitter"></i></a></div>
          </div>
          <div class="box"><img src="images/t2.jpg" alt="">
            <h2>Mokhtar Elmahdy</h2>
            <p>Front-End-Developer</p>
            <div class="links"><a class="facebook" href=""><i class="fab fa-facebook-f"></i></a><a class="insta" href=""><i class="fab fa-instagram"></i></a><a class="twitter" href=""><i class="fab fa-twitter"></i></a></div>
          </div>
          <div class="box"><img src="images/t3.jpg" alt="">
            <h2>Hager abdelaliem</h2>
            <p>Back-End-Developer</p>
            <div class="links"><a class="facebook" href=""><i class="fab fa-facebook-f"></i></a><a class="insta" href=""><i class="fab fa-instagram"></i></a><a class="twitter" href=""><i class="fab fa-twitter"></i></a></div>
          </div>
          <div class="box"><img src="images/t4.jpg" alt="">
            <h2>Hadeer Ali</h2>
            <p>Back-End-Developer</p>
            <div class="links"><a class="facebook" href=""><i class="fab fa-facebook-f"></i></a><a class="insta" href=""><i class="fab fa-instagram"></i></a><a class="twitter" href=""><i class="fab fa-twitter"></i></a></div>
          </div>
