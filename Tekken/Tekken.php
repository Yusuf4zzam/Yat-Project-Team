...
<meta name="description" content="Tekken is one of the best fighting game series out there. This game actually popularized the 3D fighting game genre even though it wasn’t the first. Tekken 7 is the most recent release in the series and brings an exciting gameplay along with highly impressive 3D graphics. Tekken 7 introduces a plethora of great characters that you can choose from.">
<meta name="keywords" content="ExGames, Tekken">
  ...
  <body>
    ...
    <div class="game">
      <div class="container">
        ...
        <div class="details">
          <p>Tekken is one of the best fighting game series out there. This game actually popularized the 3D fighting game genre even though it wasn’t the first. Tekken 7 is the most recent release in the series and brings an exciting gameplay along with highly impressive 3D graphics. Tekken 7 introduces a plethora of great characters that you can choose from.</p>
        </div>
        <?php
          if(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true)
          {
