...
<meta name="description" content="PlayerUnknown's Battlegrounds (PUBG) is an online multiplayer battle royale game developed and published by PUBG Corporation, a subsidiary of South Korean video game company Bluehole. ... PUBG Mobile, a free-to-play mobile game version for Android and iOS, was released in 2018, in addition to a port for the PlayStation 4.">
<meta name="keywords" content="ExGames, Pubg">
    ...
    <div class="game">
      <div class="container">
        <div class="head flex align-center">
          <div class="image"><img src="images/pubg-icon.jpg" alt=""></div>
          <div class="text">
            <h3>Pubg</h3>
        ...
        <?php
          if(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true)
          {
            echo'<div class="link"><a class="global-hover" download="images/pubg1.jpg" href="data:application/octet-stream;base64,PD94ANDSOON">Download</a></div>';
          }
        ?>
      </div>
    </div>
