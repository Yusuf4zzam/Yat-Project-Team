...
<meta name="description" content="Yet another game that you should definitely check out if you’re looking for an online PC game, Warframe is one of those titles that, even though old, have consistently received updates and new content to keep the game fresh and exciting for both newcomers and veteran players alike. In Warframe, you control the members of a clan that have woken up from cryosleep to find themselves at war with multiple space-clans.">
<meta name="keywords" content="ExGames, Warframe">
  ...
  <body>
    ...
    <div class="game">
      <div class="container">
        ...
        <div class="details">
          <p>Yet another game that you should definitely check out if you’re looking for an online PC game, Warframe is one of those titles that, even though old, have consistently received updates and new content to keep the game fresh and exciting for both newcomers and veteran players alike. In Warframe, you control the members of a clan that have woken up from cryosleep to find themselves at war with multiple space-clans.</p>
        </div>
        <?php
          if(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true)
          {
